...
// //       sipServer: "voice.nuke.co.in",
// //       wssServer: "wss://voice.nuke.co.in:8089/ws",
...
// //     } catch (err) {
// //       setError("Call initiation failed: " + err.message);
// //     }
// //   };
...
// //       setIsMuted(false);
// //     } catch (err) {
// //       setError("Failed to disconnect call: " + err.message);
// //     }
// //   };
...
// //     } catch (err) {
// //       setError("Failed to toggle hold: " + err.message);
// //     }
// //   };
...
// //           <h2 className="text-xl font-semibold text-gray-800">Call Controller</h2>
// //           <button onClick={() => onClose(resetModalState)} className="text-gray-500 hover:text-gray-700">
...
// //           {startTime && (
// //             <p className="text-sm text-gray-600">
// //               Duration: <span className="font-medium">{formatDuration(callDuration)}</span>
// //             </p>
// //           )}
// //           {startTime && (
// //             <p className="text-sm text-gray-600">
// //               Start Time: <span className="font-medium">{new Date(startTime).toLocaleTimeString()}</span>
// //             </p>
// //           )}
// //           {endTime && (
// //             <p className="text-sm text-gray-600">
// //               End Time: <span className="font-medium">{new Date(endTime).toLocaleTimeString()}</span>
// //             </p>
// //           )}
// //         </div>
...
// //             <span>{callData?.customer_name || "Unknown Customer"}</span>
// //           </div>
// //           <div className="flex items-center space-x-2">
// //             <FiPhone className="text-blue-500" />
// //             <span>{callData?.phone_number || "N/A"}</span>
// //           </div>
// //         </div>
...
// //             className="bg-green-500 hover:bg-green-600 text-white rounded-lg p-3 flex items-center justify-center space-x-2"
// //           >
// //             <FaPhoneAlt />
// //             <span>Call</span>
// //           </button>
...
// //             disabled={callStatus === "idle"}
// //             className="bg-red-500 hover:bg-red-600 text-white rounded-lg p-3 flex items-center justify-center space-x-2"
// //           >
// //             <FaPhoneSlash />
// //             <span>Hang Up</span>
// //           </button>
...
// //             } hover:opacity-90 text-white rounded-lg p-3 flex items-center justify-center space-x-2`}
// //           >
...
// //             onClick={handleHold}
// //             disabled={callStatus === "idle"}
// //             className="bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg p-3 flex items-center justify-center space-x-2"
// //           >
...
// //             className="mt-2 bg-blue-500 hover:bg-blue-600 text-white p-2 rounded-lg w-full"
// //           >
// //             Submit Details
// //           </button>
// //         </div>
...
//   // Disconnect Call and Close Modal
//   const handleDisconnect = async () => {
//     try {
//       if (callID) {
//         phoneRef.current.endCall(callID);
